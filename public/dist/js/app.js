...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.state = {
            cards: [{ id: 1, status: false, show: false, image: "https://shibecdn.azureedge.net/cats/8a46d765b1fa3cf9300641b45c483d0198748b51.jpg" }, { id: 2, status: false, show: false, image: 'https://shibecdn.azureedge.net/cats/6d7614fc80f0319336b0a0f3af3a41e050182449.jpg' }, { id: 3, status: false, show: false, image: 'https://shibecdn.azureedge.net/cats/46a9dff816ad8f2e990ffeb851f138a34880f3e9.jpg' }, { id: 4, status: false, show: false, image: 'https://shibecdn.azureedge.net/cats/09789aa135951d28b144863a9f835244c897e214.jpg' }],
            show: true
        };

        _this.handleToggle = _this.handleToggle.bind(_this);
        _this.showImages = _this.showImages.bind(_this);
        return _this;
    }
        ...
        value: function handleToggle(id) {
            ...
            for (var x in newState.cards) {
                if (newState.cards[x].status) {
                    if (newState.cards[x].id != id) newState.cards[x].status = false;
                }
        ...
        value: function createCards() {
            ...
            var cards = this.state.cards.map(function (card, index) {
                return _react2.default.createElement(
                    'div',
                    { className: 'col col-lg-3 card-container', key: index },
                        ...
                        _react2.default.createElement(
                            'div',
                            {
                                onClick: function onClick() {
                                    return _this2.handleToggle(card.id);
                                },
...
*/
var aa=__webpack_require__(2),ba=__webpack_require__(6),m=__webpack_require__(15),p=__webpack_require__(4),v=__webpack_require__(3),da=__webpack_require__(16),ea=__webpack_require__(17),fa=__webpack_require__(18),ha=__webpack_require__(5);
